...
[
  ...
  bonus ;bonus money per time, based off of product 2
  money ;current money
  product1 ;bools for products owned
  product2
...
to move-turtles
  ask turtles
  [
    right random 360 ;set turtle to random direction
    forward 1;move forward 1 unit
  ]
end
...
true
false
"set-histogram-num-bars 10\n" "set-plot-x-range 0 [money] of (max-one-of turtles [money])\nset-plot-y-range 0 agentNum"
PENS
"Turtle Money" 1.0 1 -7500403 true "" "histogram [money] of turtles"
